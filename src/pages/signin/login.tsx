...
const Inputs = () => {
  ...
  return (
    <div className="h-full w-full">
      <div className=" h-full flex-wrap items-center justify-center lg:justify-between">
        <div className="">
          <form>
            <div className="relative" data-te-input-wrapper-init>
              ...
              <input
                type="text"
                className="peer  border border-black block w-full rounded py-[0.32rem] px-3 leading-[2.15]  mb-6"
